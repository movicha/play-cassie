...
import com.clouidio.orm.impl.bindings.ProductionBindings;
...
public class TestGrammar {
	...
	public void testOptimizeBetween() {
		...
		String result = "" + newTree;
		Assert.assertEquals(
				"(:asfd < p.leftside <= :fdfd and :ff <= p.rightside < :tttt)",
				result);
	}
	...
	public void testRewriteJoin() {
		...
		String result = "" + newTree;
		Assert.assertEquals(
				"(s.securityType = :type and(innerjoin) p.numShares = :shares)",
				result);
	}
	...
	public void testNoRewrite() {
		...
		String result = "" + newTree;
		Assert.assertEquals(
				"(p.numShares = :shares and p.something = :something)", result);
	}
	...
	public void testLargeTree() {
		...
		String result = "" + newTree;
		Assert.assertEquals(
				"((h.f > :a and(innerjoin) ((f.x > :a and f.y > :a) or(innerjoin) (g.x > :a and g.y > :a))) and(innerjoin) (((d.y > :a and(innerjoin) a.y > :a) or (b.z > :a and(innerjoin) a.z > :a)) and (e.y > :a and(innerjoin) b.x > :a)))",
				result);
	}
