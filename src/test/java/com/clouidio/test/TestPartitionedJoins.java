...
public class TestPartitionedJoins {
	...
	public void testInnerJoin() {
		...
		List<PartitionedTrade> trades = PartitionedTrade.findInPartition(mgr,
				5, "one", null);
	...
	public void testLeftOuterJoin() {
		...
		List<PartitionedTrade> trades = PartitionedTrade.findLeftOuter(mgr, 5,
				"one", null);
