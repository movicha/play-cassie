...
import com.clouidio.test.db.EntityWithDateTimeKey;
import com.clouidio.test.db.EntityWithIntKey;
import com.clouidio.test.db.EntityWithUUIDKey;
...
public class TestKeysAndBasic {
	...
	public void testIntegerKey() {
		...
		EntityWithIntKey entity = mgr2
				.find(EntityWithIntKey.class, act.getId());
	...
	public void testLocalDateTimeKey() {
		...
		NoSqlEntityManager mgr2 = factory.createEntityManager();
		EntityWithDateTimeKey entity = mgr2.find(EntityWithDateTimeKey.class,
				k.getId());
	...
	public void testUUIDKey() {
		...
		NoSqlEntityManager mgr2 = factory.createEntityManager();
		EntityWithUUIDKey entity = mgr2.find(EntityWithUUIDKey.class,
				enUID.getId());
