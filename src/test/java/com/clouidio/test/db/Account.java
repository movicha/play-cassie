...
public class Account extends AccountSuper {
	...
	public static List<Account> findBetween(NoSqlEntityManager mgr,
			float begin, float to) {
		Query<Account> query = mgr.createNamedQuery(Account.class,
				"findBetween");
	...
	public static List<Account> findAnd(NoSqlEntityManager mgr, String name,
			Boolean active) {
	...
	public static List<Account> findAndBackward(NoSqlEntityManager mgr,
	...
	public static List<Account> findOrBackward(NoSqlEntityManager mgr,
			String name, Boolean active) {
		Query<Account> query = mgr.createNamedQuery(Account.class, "findOr");
		query.setParameter("name", name);
		query.setParameter("active", active);
