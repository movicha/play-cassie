...
public class Activity {
	...
	public static List<Activity> findBetween(NoSqlEntityManager mgr, long from,
			long to) {
	...
	public static List<Activity> findBetween2(NoSqlEntityManager mgr,
			long from, long to) {
		Query<Activity> query = mgr.createNamedQuery(Activity.class,
				"findBetween2");
		query.setParameter("begin", from);
	...
	public static List<Activity> findByCool(NoSqlEntityManager mgr,
			boolean isCool) {
		Query<Activity> query = mgr.createNamedQuery(Activity.class,
				"findByCool");
	...
	public static List<Activity> findNumTimes(NoSqlEntityManager mgr,
			long numTimes) {
		Query<Activity> query = mgr.createNamedQuery(Activity.class,
				"findByNumTimes");
	...
	public static List<Activity> findByFloat(NoSqlEntityManager mgr,
			float myFloat) {
		Query<Activity> query = mgr.createNamedQuery(Activity.class,
				"findByFloat");
	...
	public static List<Activity> findById(NoSqlEntityManager mgr, String id) {
		Query<Activity> query = mgr
				.createNamedQuery(Activity.class, "findById");
		query.setParameter("id", id);
		return query.getResultList(0, null);
	}

	public static List<Activity> findWithAnd(NoSqlEntityManager mgr,
			String name, long numTimes) {
		Query<Activity> query = mgr.createNamedQuery(Activity.class,
				"findWithAnd");
		query.setParameter("name", name);
		query.setParameter("numTimes", numTimes);
	...
	public static List<Activity> findWithOr(NoSqlEntityManager mgr,
			String name, long numTimes) {
		Query<Activity> query = mgr.createNamedQuery(Activity.class,
				"findWithOr");
		query.setParameter("name", name);
	...
	public static List<Activity> findWithoutParens(NoSqlEntityManager mgr,
		...
		Query<Activity> query = mgr.createNamedQuery(Activity.class,
				"findWithoutParens");
		query.setParameter("name", name).setParameter("numTimes", numTimes)
				.setParameter("myFloat", myFloat);
		return query.getResultList(0, null);
	}
	...
	public static List<Activity> findByAccount(NoSqlEntityManager mgr,
			Account account) {
		Query<Activity> query = mgr.createNamedQuery(Activity.class,
				"findByAccount");
