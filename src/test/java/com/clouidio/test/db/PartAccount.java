...
@NoSqlEntity
@NoSqlQueries({ @NoSqlQuery(name = "findAll", query = "select *  from TABLE as d") })
public class PartAccount {
	...
	public static Iterable<KeyValue<PartAccount>> findAll2(
			NoSqlEntityManager mgr) {
		Query<PartAccount> query = mgr.createNamedQuery(PartAccount.class,
				"findAll");
