...
public interface QueryResult {
	...
	/**
	 * This cursor is a cursor into JUST the row keys of the entites that match
	 * the query.
	 * 
	...
	/**
	 * This cursor on every cursor.next/cursor.getCurrent returns a List of the
	 * joined rows so you could display in a command line or GUI tool the
	 * results(and page the results).
	 * 
	...
	/**
	 * This cursor ONLY returns the primary View's rows and NOT the rows that
	 * were joined with though the primary view usually contains the other row
	 * keys in a ManyToOne or OneToOne case anyways.
	 * 
