package com.clouidio.orm.api.z8spi.conv;
...
public class Converters {
	...
	public static abstract class BaseConverter implements Converter {
		...
		// This is overloaded for stuff like byte[] types which need to convert
		// to Hex
	...
	public static abstract class DecimalConverter extends BaseConverter {
		...
		public Object convertFromNoSqlImpl(byte[] data) {
			BigDecimal bigD = (BigDecimal) BIGDECIMAL_CONVERTER
					.convertFromNoSql(data);
	...
	public static abstract class IntegerConverter extends BaseConverter {
		...
		public Object convertFromNoSqlImpl(byte[] data) {
			BigInteger bigD = (BigInteger) BIGINTEGER_CONVERTER
					.convertFromNoSql(data);
			return convertFromForSmallStorage(bigD);
		}
	...
	public static class FloatConverter extends DecimalConverter {
		...
		protected BigDecimal convertToForSmallStorage(Object value) {
			Float f = (Float) value;
			// NOTE: Must convert to string here or when you feed BigDecimal,
			// the
	...
	public static class BooleanConverter extends BaseConverter {
		...
		@Override
		public Object convertFromNoSqlImpl(byte[] bytes) {
			Integer value = StandardConverters.convertFromBytes(Integer.class,
					bytes);
			if (value == 1)
				return true;
			return false;
	...
	public static class UUIDConverter extends BaseConverter {
		...
		public byte[] convertToNoSqlImpl(Object value) {
			...
			System.arraycopy(nodeArray, 0, combinedUUID, timeArray.length,
					nodeArray.length);
			return combinedUUID;
		}
		...
		public Object convertFromNoSqlImpl(byte[] value) {
			try {
				...
				long time = StandardConverters.convertFromBytes(Long.class,
						timeArray);
				long clockSeqAndNode = StandardConverters.convertFromBytes(
						Long.class, clockSeqAndNodeArray);
