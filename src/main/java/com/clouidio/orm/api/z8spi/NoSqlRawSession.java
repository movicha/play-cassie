...
public interface NoSqlRawSession {
	...
	/**
	 * Action is subclassed by Remove and Persist and will be executed in the
	 * order we are given here
	 * 
	 * @param actions
	 */
	 ...
	 * @param scan
	 * @param from
	 *            If null, it means open ended otherwise we scan from this key
	 *            inclusive or exclusively depending on the field inside the Key
	 * @param to
	 *            If null, it means open ended otherwise we scan to this key
	 *            inclusive or exclusively depending on the field inside the Key
	 * @param batchSize
