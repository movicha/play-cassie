...
import com.clouidio.orm.api.base.anno.NoSqlInheritanceType;
...
public abstract class DboColumnMeta {
	...
	protected void removeIndexInfo(InfoForIndex<TypedRow> info, Object value,
			byte[] byteVal) {
