...
public class ScanInfo {
	...
	public static ScanInfo createScanInfo(DboColumnMeta colMeta,
		...
		ScanInfo scanInfo = new ScanInfo(realColFamily, colMeta, columnFamily,
				rowKey);
		return scanInfo;
	}

	public ScanInfo(String indexColFamily, DboTableMeta realColFamily,
			byte[] rowKey2) {
	...
	public ScanInfo(DboTableMeta realColFamily, DboColumnMeta colName,
			String indexColFamily, byte[] rowKey2) {
		this.entityColFamily = realColFamily;
	...
	public String toString() {
		return "CF=" + indexColFamily + "(for cf=" + entityColFamily
				+ ") rowKey=" + toUTF8(rowKey);
	}
