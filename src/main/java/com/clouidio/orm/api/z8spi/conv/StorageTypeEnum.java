...
public enum StorageTypeEnum {
	...
	STRING("String", String.class), DECIMAL("Decimal", BigDecimal.class), INTEGER(
			"Integer", Integer.class), BYTES("Bytes", byte[].class), BOOLEAN(
			"Boolean", Boolean.class), NULL("Null", void.class);
	...
	public ColumnType translateStoreToColumnType() {
		...
		case BYTES:
			throw new UnsupportedOperationException(
					"not sure if we need this one or not yet");
		default:
			throw new UnsupportedOperationException("We don't translate type="
					+ this + " just yet");
		}
	}
