...
/**
 * NOTE: The type information is either from another constant or from the
 * column's type so we have to compare against one or the other in this bean.
 * 
 * @author Alex Barreto
 * 
 */
public class TypeInfo {
	...
	/**
	 * NOTE: The type information is either from another constant or from the
	 * column's type so we have to compare against one or the other field in
	 * this bean.
	 */
