...
public class SetProxyFetchAll<T> extends OurAbstractCollection<T> implements
		CacheLoadCallback, Set<T> {

	@SuppressWarnings("unused")
	private static final long serialVersionUID = 1L;
	private Set<Holder<T>> holders = new HashSet<Holder<T>>();

	public SetProxyFetchAll(Object owner, NoSqlSession session,
