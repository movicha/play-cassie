...
public class Utf8Comparator implements Comparator<ByteArray> {
	...
	public int compare(ByteArray o1, ByteArray o2) {
		...
		String left = StandardConverters.convertFromBytes(String.class,
				o1.getKey());
		String right = StandardConverters.convertFromBytes(String.class,
				o2.getKey());
		int result = left.compareTo(right);
		if (result != 0)
			return result;

		// otherwise, in the case of certain composites, we must now compare
		// ByteArrays to match cassandra
