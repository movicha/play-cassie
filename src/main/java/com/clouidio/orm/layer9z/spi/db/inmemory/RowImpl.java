...
public class RowImpl implements Row {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.clouidio.orm.layer3.spi.db.inmemory.RowTemp#getKey()
	 */
	@Override
	public byte[] getKey() {
		return key;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.clouidio.orm.layer3.spi.db.inmemory.RowTemp#setKey(byte[])
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.clouidio.orm.layer3.spi.db.inmemory.RowTemp#getColumns()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.clouidio.orm.layer3.spi.db.inmemory.RowTemp#getColumn(byte[])
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.clouidio.orm.layer3.spi.db.inmemory.RowTemp#put(byte[],
	 * com.clouidio.orm.api.spi3.db.Column)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.clouidio.orm.layer3.spi.db.inmemory.RowTemp#remove(byte[])
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.clouidio.orm.layer3.spi.db.inmemory.RowTemp#columnSlice(byte[],
	 * byte[])
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.clouidio.orm.layer3.spi.db.inmemory.RowTemp#columnByPrefix(byte[])
	 */
	@Override
	public Collection<Column> columnByPrefix(byte[] prefix) {
		...
		for (Entry<ByteArray, Column> col : columns.entrySet()) {
			if (col.getKey().hasPrefix(prefix)) {
				...
				break; // since we hit the prefix and we are sorted, we can
						// break.
		}
