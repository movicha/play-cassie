...
public class CursorOfIndexes extends AbstractCursor<IndexColumn> {
	...
	@Override
	public com.clouidio.orm.api.z8spi.iter.AbstractCursor.Holder<IndexColumn> nextImpl() {
		loadCache();
	...
	@Override
	public com.clouidio.orm.api.z8spi.iter.AbstractCursor.Holder<IndexColumn> previousImpl() {
		loadCacheBackward();
	...
	private void loadCache() {
		...
		if (needToGetBatch) {
			...
			BasicDBObject rangeQuery = MongoDbUtil.createRowQuery(from, to,
					columnMeta);
			query.put("i",
