...
public class PrefixComparator implements Comparator<OurKey> {
	...
	public int compare(OurKey o1, OurKey o2) {
		...
		// If prefixes are equal, we still need to sort them and order doesn't
		// really matter so we will sort by
		// the postfix ByteArray

		// If postfix is null, it is greater than everything and should ONLY be
		// used when querying anyways!!!
