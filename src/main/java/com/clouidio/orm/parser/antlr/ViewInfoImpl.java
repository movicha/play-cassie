...
/**
 * A Table can have different aliases like in a self-join where the table is
 * alias "a" and alias "b" This class is a View of a or a View of b, such that
 * everyone referring to "a" has one ViewInfo and everyone with "b" has nother
 * ViewInfo
 * 
 * @author Alex Barreto
 */
	...
	public JoinInfo getJoinInfo(ViewInfoImpl table2) {
		...
		if (table2.equals(this))
			throw new IllegalArgumentException(
					"bug, you can't pass in our view even on self join because view is always different");
