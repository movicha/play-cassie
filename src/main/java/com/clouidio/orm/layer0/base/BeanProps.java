...
/**
 * All because darn apache commons BeanUtils copies by method which breaks for
 * some clients when they don't have getters/setters AND they should not have to
...
public class BeanProps {
	...
	public static void copyPropsImpl(Object src, Object dest)
