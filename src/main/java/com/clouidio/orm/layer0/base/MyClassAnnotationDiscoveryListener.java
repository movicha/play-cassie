...
import com.clouidio.orm.impl.meta.scan.ScannerForClass;
...
public class MyClassAnnotationDiscoveryListener implements
	...
	private static final Logger log = LoggerFactory
			.getLogger(MyClassAnnotationDiscoveryListener.class);
	...
	public String[] supportedAnnotations() {
		return new String[] { NoSqlEntity.class.getName(),
				NoSqlEmbeddable.class.getName() };
	}
	...
	public void scanClass(Class<?> clazz) {
		try {
			...
			throw new RuntimeException(
					"Failure scanning class(see chained exception)=" + clazz, e);
		}
	}
