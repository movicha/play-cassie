...
public class CursorToIndexPoint extends AbstractCursor<IndexPoint> {
	...
	public CursorToIndexPoint(DboColumnIdMeta idMeta, DboColumnMeta colMeta,
			AbstractCursor<IndexColumn> indCol) {
		this.idMeta = idMeta;
	...
	public String toString() {
		...
		String retVal = "CursorToIndexPoint[" + tabs + indCol + tabs
				+ valueMeta + tabs + "]";
