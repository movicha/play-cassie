...
public class NoSqlPlugin extends PlayPlugin {
	...
	private static final Logger log = LoggerFactory
			.getLogger(NoSqlPlugin.class);

	@SuppressWarnings({ "unchecked", "rawtypes" })
	@Override
	public Object bind(RootParamNode rootParamNode, String name, Class clazz,
		...
		if (o == null)
			throw new RowNotFoundException(
					"Row with rowkey="
							+ theId
							+ " was not found, but your page posted this id to lookup the row of class type="
							+ clazz.getSimpleName());
	...
	public void onApplicationStart() {
		List<Class> classes = Play.classloader
				.getAnnotatedClasses(NoSqlEntity.class);
		if (classes.isEmpty())
			return;
		...
		for (java.util.Map.Entry<Object, Object> entry : Play.configuration
				.entrySet()) {
		...
		NoSqlEntityManagerFactory factory = Bootstrap.create(props,
				Play.classloader);
	...
	public void beforeInvocation() {
		...
		NoSqlEntityManager manager = NoSql.getEntityManagerFactory()
				.createEntityManager();
