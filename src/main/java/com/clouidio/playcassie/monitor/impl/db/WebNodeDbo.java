...
public class WebNodeDbo {
	...
	// purely for index and NOT on isUp on purpose as we could get corrupt index
	// too easily with computers running
	@NoSqlIndexed
	...
	public String toString() {
		return "[webNode=" + webServerName + " up=" + isUp + " lastSeen="
				+ lastSeen + "]";
	}
	...
	public static Cursor<KeyValue<WebNodeDbo>> findAllNodes(
