 ...
 */
public interface MethodAnnotationDiscoveryListener extends
	 ...
	 * @param method
	 * @param signature
	 *            (read: http://java.sun.com/docs/books/jvms/second_edition/
	 *            ClassFileFormat-Java5.pdf)
	 * @param annotation
	 */
	void discovered(String clazz, String method, String signature,
			String annotation);
}
