 ...
 */
package com.clouidio.annovention.resource;
...
public final class JarFileIterator implements ResourceIterator {
	...
	private static final Logger log = LoggerFactory
			.getLogger(JarFileIterator.class);
	...
	/* @see com.clouidio.annovention.resource.ResourceIterator#next() */
	@Override
	...
	/* @see com.clouidio.annovention.resource.ResourceIterator#close() */
	@Override
	public void close() {
		try {
			closed = true;
